...
but only the common interface layer is used, maing no distinctions between plotting backends.
Each submodule inside ``arviz_plots.backend`` is expected to implement the same funcions
