...
def plot_ess_evolution(
    ...
    **pc_kwargs
    ...
    bulk_line_kwargs = get_visual_kwargs(visuals, "ess_bulk_line")
    ...
    tail_kwargs = get_visual_kwargs(visuals, "ess_tail")
    ...
    tail_line_kwargs = get_visual_kwargs(visuals, "ess_tail_line")
