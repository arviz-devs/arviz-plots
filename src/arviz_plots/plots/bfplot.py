...
from arviz_plots.visuals import annotate_xy, vline
...
def plot_bf(
    ...
    if bf_text_kwargs is not False:
        _, bf_text_aes, bf_text_ignore = filter_aes( # pylint: disable=W0612
    ...
    if backend == "matplotlib":  ## remove this when we have a better way to handle legends
        plot_collection.add_legend("Groups", loc="outside right upper")
